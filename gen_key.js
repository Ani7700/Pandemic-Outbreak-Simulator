...
const ORDER=['C1','C_dose2','C_ratio','C5','C_half','C_diff','Q_whichfig','A_peakht',
             'B_cases','Fpeaktime','Q_thresh','Q_gist','Q_nonlinear','Q_band'];
...
const STAR=new Set(['C1','C_dose2','C_ratio','C5','C_half','C_diff','Q_whichfig']);
